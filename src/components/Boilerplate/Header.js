    ...
    <nav class="bg-black shadow dark:bg-gray-800">
        <div class="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-2xl font-bold text-white dark:text-white md:text-2xl hover:text-gray-300 dark:hover:text-gray-300" >
            ...
            <div class="items-center md:flex">
                ...
                <div class="flex justify-center md:block">
                    <p class="relative text-white dark:text-gray-200 hover:text-gray-200 dark:hover:text-gray-300" >
                        <Link to="/cart">
